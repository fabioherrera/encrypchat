...
# Flutter Windows is MSVC: this host cannot compile the .exe. The target wraps
# a CI (or Windows-desk) bundle in an NSIS per-user installer, or explains how
# to get that bundle. See scripts/package-windows.sh.
package-windows:
